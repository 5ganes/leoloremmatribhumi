	...
	<li>
  	...
  	<li>
    	...
    	<ul>
            ...
            <li><a href="cms.php?id=274&parentId=0&groupType=Other">Message From LEO President</a></li>
            <li>
              <a href="cms.php?id=<?php echo MSG_FROM_SPOKEPERSON;?>&parentId=0&groupType=Other">Message From LEO Treasurer</a>
            </li>
            <li>
              <a href="cms.php?id=<?php echo MSG_FROM_DDG;?>&parentId=0&groupType=Other">Msg From Lions Club Advisor</a>
            </li>
            <li><a href="cms.php?id=362&parentId=0&groupType=Other">Msg From LEO Secretary</a></li>
            <li>
              <a href="cms.php?id=828&parentId=0&groupType=Other">Msg From Lions President</a>
            </li>
